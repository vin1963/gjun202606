...
public class UserWebController {
    ...
    // 處理建立表單
    @PostMapping("/create")
    public String createUser(@ModelAttribute User2 user, RedirectAttributes redirectAttributes) {
        User2 createdUser = userService.createUser(user.getName(), user.getEmail(), user.getAge());
    ...
    // 處理編輯表單
    @PostMapping("/{id}/edit")
    public String updateUser(@PathVariable String id, @ModelAttribute User2 user, 
